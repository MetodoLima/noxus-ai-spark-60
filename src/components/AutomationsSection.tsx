  ...
  const automations = [
    {
      ...
      image: "/lovable-uploads/0701fc7d-fa7f-43eb-bfb4-7ddcc2515d5d.png",
      showPhone: false
    },
    {
          ...
          {automations.map((automation, index) => (
            ...
            >
              <div className="w-full md:w-1/2 space-y-4">
                ...
                <GradientButton className="gradient-button-noxus-primary">
                  Saiba mais
                </GradientButton>
              </div>
              ...
              <div className="w-full md:w-1/2">
                {index === 0 ? (
                  // Special treatment for the first automation - use the uploaded image
                  <div className="relative max-w-md mx-auto">
                    <img 
                      src={automation.image} 
                      alt="Automação do WhatsApp" 
                      className="w-full h-auto"
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-noxus-dark-blue/20 via-transparent to-transparent rounded-lg"></div>
                  </div>
                ) : (
                  // Regular phone mockup for other automations
                      ...
                      <div className="rounded-[32px] overflow-hidden bg-white h-[560px] w-[280px] relative">
                        ...
                        <div className="p-4 h-[calc(100%-40px)] bg-gray-50 flex flex-col">
                          ...
                          <div className="flex-1 py-4 space-y-4 overflow-auto">
                            {automation.chats && automation.chats.map((chat, chatIndex) => (
                              <div 
                                key={chatIndex} 
