...
function HeroGeometric({
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-noxus-dark-blue to-noxus-blue">
            <div className="absolute inset-0 bg-gradient-to-br from-noxus-blue/[0.05] via-transparent to-noxus-cyan/[0.05] blur-3xl" />
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <ElegantShape
                    ...
                    height={80}
                    rotate={-8}
                    gradient="from-noxus-light-blue/[0.15]"
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 pt-20">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <Circle className="h-2 w-2 fill-noxus-cyan" />
                    ...
                    >
                        <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 md:mb-8 tracking-tight">
                            ...
                            <span
                                className={cn(
                                    "bg-clip-text text-transparent bg-gradient-to-r from-noxus-light-blue via-white/90 to-noxus-cyan"
                                )}
                            >
                                {title2}
                            </span>
