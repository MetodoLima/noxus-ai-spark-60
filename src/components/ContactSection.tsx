    ...
    <section id="contato" className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-noxus-blue font-medium mb-2">CONTATO</h2>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3 bg-white rounded-lg p-6 shadow-md">
            <h4 className="text-xl font-bold text-noxus-dark-blue mb-4">Envie uma Mensagem</h4>
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button 
                type="submit" 
                className="w-full bg-gradient-to-r from-noxus-blue to-noxus-cyan text-white hover:opacity-90"
